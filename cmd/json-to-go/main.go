...
func showHelp() {
	...
	fmt.Println("\n  # From URL:")
	fmt.Println("  json-to-go https://api.example.com/users/1")
	fmt.Println("  json-to-go -url=https://api.example.com/data")
	fmt.Println("\n  # With custom type name:")
	fmt.Println(`  echo '{"name":"John"}' | json-to-go -type=Person`)
	fmt.Println("\n  # Write to file:")
	fmt.Println("  json-to-go -url=https://api.example.com/data -output=structs.go")
	fmt.Println("  json-to-go data.json -output=types.go -type=User")
